...
font_path = "fonts/Sga-Regular.ttf"  # Make sure this path is correct
output_path = "sga_spiral_grid_glow.png"
...
# === Load font ===
try:
    font = ImageFont.truetype(font_path, size=42)  # Slightly smaller font size
except IOError:
